...
const Body = () => {
    ...
    const fetchData = async () => {
        const data = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=13.0215821&lng=77.6604131&page_type=DESKTOP_WEB_LISTING");
        ...
        <div className="body">
            <div className="flex">
                <div className="Search m-4 p-4">
                    <input type="text" className="border border-solid border-black" name="Search" id="" data-testid="searchInput" value={searchText} onChange={(e) => {
